...
<form action="{{route('admin.main.update')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3 mt-3">
            ...
            <img style="height: 30vh" src="{{asset($main->bg_img)}}" class="img-thumbnail">
        ...
        <div class="form-group col-md-4 mt-3">
            ...
            <div class="mb-5">
                <label for="sub_title"><h4>Website Name</h4></label>
                <input type="text" class="form-control" id="website_name" name="website_name" value="{{$main->website_name}}">
            </div>
            <div>
                <h4>Upload Resume</h4>
